...
IMPORTANT: The "server" field MUST be written in Chinese (e.g. "💰 金融分析师"), not English. The agent_role_prompt can remain in English as it is internal instructions for the model.
